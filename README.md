...
**Status:** route A (lokaal en volledig open source, geen cloud) werkt (v0.3) voor platte 2,5D-onderdelen met doorgaande gaten. Getest op synthetische scans, ook met storingen uit echte foto's. Het gereedschap om met echte foto's en schuifmaatmetingen te valideren is klaar ([Fase 0](docs/FASE-0.md)); de meetset zelf volgt.
...
- [Route A — verbeterpunten](docs/ROUTE-A-VERBETERPUNTEN.md): stresstests, codereview en stand van de techniek (2026), geprioriteerd, met wat er in v0.2 en v0.3 al is opgelost.
